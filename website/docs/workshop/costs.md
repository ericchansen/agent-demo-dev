...
| Databricks SQL warehouse | Usage-based | Only needed if you choose the Databricks path; stop the warehouse after labs |
...
> 📖 [Fabric capacity pricing](https://learn.microsoft.com/fabric/enterprise/licenses) · [Azure Cost Management](https://learn.microsoft.com/azure/cost-management-billing/costs/quick-acm-cost-analysis) · [Microsoft Foundry overview](https://learn.microsoft.com/en-us/azure/foundry/)
